...
public class CrossrefPdfByDoiExtensionFunctionDef extends ExtensionFunctionDefinition {

	private CrossrefApiCaller crossref = new CrossrefApiCaller();
	
	@Override
	public StructuredQName getFunctionQName() {
		return new StructuredQName("crossref", "http://www.zpid.de/crossref", "pdfByDoi"); 
	}
	...
	public ExtensionFunctionCall makeCallExpression() {
		return new ExtensionFunctionCall() {
			...
			@Override public Sequence call(
				...
				String result = crossref.getPdfByDoi(doi);
